...
let sendSimpleEmail = async (dataSend) => {
    ...
    let info = await transporter.sendMail({
        from: '"Bookingcare.vn 👻" <trungdung1d7@gmail.com>', // sender address
...
let getBodyHTMLEmail = (dataSend) => {
    ...
    if (dataSend.language === 'en') {
        ...
        <p>You received this email because you booked an online medical appointment on the Bookingcare.vn</p>
...
let getBodyHTMLEmailRemedy = (dataSend) => {
    ...
    if (dataSend.language === 'vi') {
        result =
            `
        <h3>Xin chào ${dataSend.patientName}!</h3>
        <p>Bạn nhận được email này vì đã đặt lịch khám bệnh online trên Bookingcare.vn thành công.</p>
